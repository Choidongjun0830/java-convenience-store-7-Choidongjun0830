...
public class ExceptionMessage {
    ...
    public static final String PURCHASE_NAME_BLANK_EXCEPTION = EXCEPTION_PREFIX + " 상품 이름은 공백될 수 없습니다.";
    public static final String PURCHASE_AMOUNT_INVALID_EXCEPTION = EXCEPTION_PREFIX + " 구매할 상품 수량은 1보다 작을 수 없습니다.";
    public static final String PURCHASE_PRODUCTS_DELIMITER_EXCEPTION = EXCEPTION_PREFIX + " '-' 구분자를 사용해주세요.";
}
